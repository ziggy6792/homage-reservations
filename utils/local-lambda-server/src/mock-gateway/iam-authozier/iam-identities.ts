...
export const lambdaRoleIdentity: IIamIdentity = {
  ...
  cognitoAuthenticationProvider: null,
  userArn: 'arn:aws:sts::932244219675:assumed-role/cdk-monorepo-backend-stag-cdkmonorepobackenduserco-NMHY7FLZF98E/cdk-monorepo-backend-user-confirmed-staging',
